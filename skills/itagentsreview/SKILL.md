...
If the global templates folder is missing, create these `.agents/*.md` files inline. Each file's content matches the equivalent template under `agents/` in this repo (see the agents/ folder of WilowForClaude-itagents). Use the exact frontmatter and body. Default agents to create:
...
For source content, fetch from: https://github.com/fransanda/WilowForClaude-itagents/tree/main/agents
