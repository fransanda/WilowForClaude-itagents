...
If the global templates folder doesn't contain `pr-merger.md`, create `.agents/pr-merger.md` using the definition from the `agents/pr-merger.md` file in the WilowForClaude-itagents repo. See: https://github.com/fransanda/WilowForClaude-itagents/tree/main/agents
